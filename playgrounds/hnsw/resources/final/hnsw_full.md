...
rithms are:  
1. 
Baseline NSW algorithm from nmslib 1.1 
(“sw-graph”). 
2. 
FLANN 1.8.4 [6]. A popular library4 containing 
...
3. 
Annoy6, 02.02.2016 build. A popular algorithm 
...
nmslib 1.1. 
5. 
FALCONN7, version 1.2. A new efficient LSH al-
...
divergence 
ImageNet 
Signatures extracted from LSVRC-2014 with 
